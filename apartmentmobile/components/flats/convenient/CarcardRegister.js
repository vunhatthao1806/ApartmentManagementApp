...
const CarcardRegister = () => {
  ...
  // const [image_mrc_m1, setImage_mrc_m1] = useState(null);
  // const [image_idcard_m1, setImage_idcard_m1] = useState(null);
  // const [image_idcard_m2, setImage_idcard_m2] = useState(null);
  // const [image_mrc_m2, setImage_mrc_m2] = useState(null);
